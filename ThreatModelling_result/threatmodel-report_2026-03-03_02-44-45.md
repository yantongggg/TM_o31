...
- **Total Evidence Findings:** 270
- **Rule Hits:** 5
- **High-Priority Keywords:** 95
...
|------------|-----------------|-----------|--------------|-------------|----------|-------|
| User Data (USERS table) | High | High | Medium | High | 7 reference(s) | Contains PII - check for encryption |
| Database (jdbc:oracle) | High | High | High | High | 2 reference(s) | Check connection string security |
| Database (mongodb) | High | High | High | High | 4 reference(s) | Check connection string security |
| Database (redis) | High | High | High | High | 3 reference(s) | Check connection string security |
| Risk Assessment Engine | Medium | High | High | High | 12 reference(s) | PATCH-SPECIFIC: Verify server-side calculation |
| Date/Time Validation | Low | High | Medium | Medium | 12 reference(s) | PATCH-SPECIFIC: Verify server-side validation |
| Transaction Processing | Medium | High | High | High | 5 reference(s) | PATCH-SPECIFIC: Verify hold enforcement |
| Authentication System | Medium | High | High | High | 14 type(s) | @preauthorize, login, @rolesallowed, oauth, @secured |
...
### [HIGH] Review 95 high-priority code patterns
...
52 auth-related indicators found. Ensure MFA, proper session management, and JWT validation.
...
*Report generated by tm-scan v1.0.0 on 2026-03-03 02:44:45*

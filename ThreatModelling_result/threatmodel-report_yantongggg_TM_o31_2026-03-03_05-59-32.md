...
**Report Date:** 2026-03-03 05:59:31
...
|-----------|------------|------------------------|----------|
| `src/inventory.py` | **Line 111** | Rule: `vuln-os-command-injection` | **CRITICAL** |
| `src/inventory.py` | **Line 177** | Rule: `vuln-os-command-injection` | **CRITICAL** |
| `src/inventory.py` | Line - | Rule: `vuln-os-command-injection` | CRITICAL |
...
| File Path | Exact Line | Trigger (Rule/Keyword) | Severity |
|-----------|------------|------------------------|----------|
| `knowledge-base/kb-threats.yaml` | **Line 439** | Rule: `vuln-hardcoded-credentials` | **CRITICAL** |
| `knowledge-base/kb-keywords.yaml` | **Line 184** | Rule: `vuln-hardcoded-credentials` | **CRITICAL** |
| `knowledge-base/kb-keywords.yaml` | **Line 188** | Rule: `vuln-hardcoded-credentials` | **CRITICAL** |
| `knowledge-base/kb-sast-rules.yaml` | **Line 40** | Rule: `vuln-hardcoded-credentials` | **CRITICAL** |
| `src/scanner.py` | **Line 354** | Rule: `vuln-hardcoded-credentials` | **CRITICAL** |
| `knowledge-base/kb-threats.yaml` | Line - | Rule: `vuln-hardcoded-credentials` | CRITICAL |
| `knowledge-base/kb-keywords.yaml` | Line - | Rule: `vuln-hardcoded-credentials` | CRITICAL |
| `knowledge-base/kb-sast-rules.yaml` | Line - | Rule: `vuln-hardcoded-credentials` | CRITICAL |
| `src/scanner.py` | Line - | Rule: `vuln-hardcoded-credentials` | CRITICAL |
...
*Report generated automatically by tm-scan v1.0.0 on 2026-03-03 05:59:31*

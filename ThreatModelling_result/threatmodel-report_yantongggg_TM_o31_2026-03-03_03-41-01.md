...
|-----------|-------------|---------|----------|
| knowledge-base/kb-keywords.yaml | - | console.log | LOW |
| knowledge-base/kb-keywords.yaml | - | password | HIGH |
| knowledge-base/kb-sast-rules.yaml | - | password | HIGH |
| knowledge-base/kb-threats.yaml | - | console.log | LOW |
| knowledge-base/kb-threats.yaml | - | password | HIGH |
| src/reporter.py | - | password | HIGH |
...
| File Path | Line Number | Trigger | Severity |
|-----------|-------------|---------|----------|
| knowledge-base/kb-keywords.yaml | - | executequery | MEDIUM |
| knowledge-base/kb-keywords.yaml | - | statement | MEDIUM |
| knowledge-base/kb-sast-rules.yaml | - | statement | MEDIUM |
| knowledge-base/kb-threats.yaml | - | executequery | MEDIUM |
| knowledge-base/kb-threats.yaml | - | statement | MEDIUM |
...
| File Path | Line Number | Trigger | Severity |
|-----------|-------------|---------|----------|
| knowledge-base/kb-keywords.yaml | - | authenticate | MEDIUM |
| knowledge-base/kb-threats.yaml | - | authenticate | MEDIUM |
| src/inventory.py | - | authenticate | MEDIUM |
| src/reporter.py | - | authenticate | MEDIUM |
...
| File Path | Line Number | Trigger | Severity |
|-----------|-------------|---------|----------|
| knowledge-base/kb-keywords.yaml | - | argon2 | MEDIUM |
| knowledge-base/kb-keywords.yaml | - | bcrypt | MEDIUM |
| knowledge-base/kb-threats.yaml | - | argon2 | MEDIUM |
| knowledge-base/kb-threats.yaml | - | bcrypt | MEDIUM |
...
| File Path | Line Number | Trigger | Severity |
|-----------|-------------|---------|----------|
| knowledge-base/kb-keywords.yaml | - | maxriskscore | HIGH |
| knowledge-base/kb-keywords.yaml | - | risk_score | HIGH |
| knowledge-base/kb-threats.yaml | - | maxriskscore | HIGH |
| knowledge-base/kb-threats.yaml | - | risk_score | HIGH |
...
| File Path | Line Number | Trigger | Severity |
|-----------|-------------|---------|----------|
| knowledge-base/kb-keywords.yaml | - | hold_transaction | HIGH |
| knowledge-base/kb-keywords.yaml | - | previous_review | HIGH |
| knowledge-base/kb-threats.yaml | - | hold_transaction | HIGH |
| knowledge-base/kb-threats.yaml | - | previous_review | HIGH |
...
*Report generated by tm-scan v1.0.0 on 2026-03-03 03:40:59*

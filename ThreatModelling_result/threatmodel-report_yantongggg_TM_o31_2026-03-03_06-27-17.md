...
**Report Date:** 2026-03-03 06:27:17
...
|-----------|------------|------------------------|----------|--------|------------|
| `knowledge-base/kb-threats.yaml` | - | Keyword: `executequery` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-threats.yaml` | - | Keyword: `statement` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `executequery` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `statement` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-sast-rules.yaml` | - | Keyword: `statement` | MEDIUM | Keyword | Low |
...
| File Path | Exact Line | Trigger (Rule/Keyword) | Severity | Source | Confidence |
|-----------|------------|------------------------|----------|--------|------------|
| `knowledge-base/kb-threats.yaml` | - | Keyword: `bcrypt` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-threats.yaml` | - | Keyword: `argon2` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `bcrypt` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `argon2` | MEDIUM | Keyword | Low |
...
| File Path | Exact Line | Trigger (Rule/Keyword) | Severity | Source | Confidence |
|-----------|------------|------------------------|----------|--------|------------|
| `knowledge-base/kb-threats.yaml` | - | Keyword: `password` | HIGH | Keyword | Low |
| `knowledge-base/kb-threats.yaml` | - | Keyword: `console.log` | LOW | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `password` | HIGH | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `console.log` | LOW | Keyword | Low |
| `knowledge-base/kb-sast-rules.yaml` | - | Keyword: `password` | HIGH | Keyword | Low |
| `src/reporter.py` | - | Keyword: `password` | HIGH | Keyword | Low |
...
| File Path | Exact Line | Trigger (Rule/Keyword) | Severity | Source | Confidence |
|-----------|------------|------------------------|----------|--------|------------|
| `knowledge-base/kb-threats.yaml` | - | Keyword: `risk_score` | HIGH | Keyword | Low |
| `knowledge-base/kb-threats.yaml` | - | Keyword: `maxriskscore` | HIGH | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `risk_score` | HIGH | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `maxriskscore` | HIGH | Keyword | Low |
...
| File Path | Exact Line | Trigger (Rule/Keyword) | Severity | Source | Confidence |
|-----------|------------|------------------------|----------|--------|------------|
| `knowledge-base/kb-threats.yaml` | - | Keyword: `hold_transaction` | HIGH | Keyword | Low |
| `knowledge-base/kb-threats.yaml` | - | Keyword: `previous_review` | HIGH | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `hold_transaction` | HIGH | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `previous_review` | HIGH | Keyword | Low |
...
| File Path | Exact Line | Trigger (Rule/Keyword) | Severity | Source | Confidence |
|-----------|------------|------------------------|----------|--------|------------|
| `knowledge-base/kb-threats.yaml` | - | Keyword: `authenticate` | MEDIUM | Keyword | Low |
| `knowledge-base/kb-keywords.yaml` | - | Keyword: `authenticate` | MEDIUM | Keyword | Low |
| `src/inventory.py` | - | Keyword: `authenticate` | MEDIUM | Keyword | Low |
| `src/reporter.py` | - | Keyword: `authenticate` | MEDIUM | Keyword | Low |
...
*Report generated automatically by tm-scan v1.0.0 on 2026-03-03 06:27:17*

...
### Assets
- User/PII Data (High sensitivity) - 22 evidence indicator(s)
- Credentials/Secrets (High sensitivity) - 28 evidence indicator(s)
...
|-----------|------------|-----------|-----------------|---------------------|
| TM-PRIV-001 | High | 8.20 | Privacy breach, regulatory fines, incident response cost | P1 - Current Sprint |
...
*Report generated by tm-scan v1.0.0 on 2026-03-03 02:58:18*
